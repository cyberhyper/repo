...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   ...
	   System.out.println("Values in row " + row + " set to " + value + "correctly.");
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   System.out.println("\t\tFind the minimum value from Column " + column);
	   ...
	   System.out.println("The minimum value in column " + column + " is " +minValue);
	   return minValue; 
   }
